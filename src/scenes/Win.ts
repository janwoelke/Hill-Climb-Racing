export default class Win extends Phaser.Scene{
    ...
    create(){
        ...
        this.coinobj = this.add.image(15, 15,"coin").setOrigin(0.5).setScale(0.15);
        ...
        this.scoretext = this.add.text(screenCenterX , screenCenterY - 100, "SCORE:" + this.params.score/10, {
